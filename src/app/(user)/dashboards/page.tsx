    ...
    <>
      ...
      {!loading && (
        <Row className="mt-4">
          <Col xs={12}>
            <DataTable
              id="user-summaries-table"
              title="Call Summaries"
              description="View and manage all your call summaries"
              ...
              emptyState={{
                title: 'No Call Summaries Found',
                description: debouncedSearch
                  ? 'Try adjusting your search or filter criteria to see results.'
                  : 'There are no call summaries available at this time.',
                icon: emptyStateIcon
              }}
              sorting={{
      ...
      <Modal show={showDetailModal} onHide={() => setShowDetailModal(false)} size="lg" scrollable>
        <ModalHeader closeButton>
          <ModalTitle>Call Summary Details</ModalTitle>
        </ModalHeader>
        <ModalBody>
          {selectedSummary && (
            <div>
